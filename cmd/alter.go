...
var alterCmd = &cobra.Command{
	Use:   "alter [db_name] [sql_query]",
	Short: "Execute an ALTER TABLE statement",
	Long:  `Executes an ALTER TABLE statement against the database to add, drop, or rename columns.`,
